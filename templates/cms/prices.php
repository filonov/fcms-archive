    ...
    <body>
        <script type="text/javascript">
            ...
            function savestring(id)
            {
                ...
                $.post("{base}cms/references/edit_price", {id: id, title: title, order: order, description: description},
                function(data){
        ...
        <div class="modal hide" id="modal_add">
            ...
            <div class="modal-body">
                <form id="form_add" class=".form-horizontal" method="post" action="{base}cms/references/add_price"> 
                    <label class="control-label" >Порядок</label>
                    <input type="text" class="input-xlarge" name="order" placeholder="14">
                    <label class="control-label" >Название</label>
                    <input type="text" class="input-xlarge" name="title" placeholder="Основная">   
                    <label class="control-label" >Описание</label>
                    <input type="text" class="input-xlarge" name="description" placeholder="5 рублей при единовременной оплате."> 
                </form>
            </div>
            <div class="modal-footer">
                <a href="#" class="btn" data-dismiss="modal">Отмена</a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <form id="formdel" method="post" action="{base}cms/references/delete_price" class="form-inline">
