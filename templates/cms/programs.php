    ...
    <body>
        <script type="text/javascript">
            ...
            function savestring(id)
            {
                ...
                $.post("{base}cms/references/edit_program", {id: id, title: title, order: order, link: link},
                function(data){
        ...
        <div class="modal hide" id="modal_add">
            ...
            <div class="modal-body">
                <form id="form_add" class=".form-horizontal" method="post" action="{base}cms/references/add_program"> 
                    <label class="control-label" >Порядок</label>
                    <input type="text" class="input-xlarge" name="order" placeholder="14">
                    <label class="control-label" >Название</label>
                    <input type="text" class="input-xlarge" name="title" placeholder="A1. Итальянский">   
                    <label class="control-label" >Ссылка</label>
                    <input type="text" class="input-xlarge" name="link" placeholder="/italiano/programma-po-italianskomu-yazuku#a1"> 
                </form>
            </div>
            <div class="modal-footer">
                <a href="#" class="btn" data-dismiss="modal">Отмена</a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <form id="formdel" method="post" action="{base}cms/references/delete_program" class="form-inline">
