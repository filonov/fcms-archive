    ...
    <body>
        <script type="text/javascript">
            ...
            function savestring(id)
            {
                ...
                $.post("{base}cms/references/edit_format", {id: id, title: title, order: order},
                function(data){
        ...
        <div class="modal hide" id="modal_add">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h3>Новыый элемент</h3>
            </div>
            <div class="modal-body">
                <form id="form_add" class=".form-horizontal" method="post" action="{base}cms/references/add_format"> 
                    <label class="control-label" >Порядок</label>
                    <input type="text" class="input-xlarge" name="order" placeholder="14">
                    <label class="control-label" >Название</label>
                    <input type="text" class="input-xlarge" name="title" placeholder="Будни вечер">     
                </form>
            </div>
            <div class="modal-footer">
                <a href="#" class="btn" data-dismiss="modal">Отмена</a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <form id="formdel" method="post" action="{base}cms/references/delete_format" class="form-inline">
