    ...
    <body>
        <script type="text/javascript">
            ...
            function savestring(id)
            {
                ...
                $.post("{base}cms/references/edit_test", {id: id, title: title, order: order, link: link},
                function(data){
        ...
        <div class="modal hide" id="modal_add">
            ...
            <div class="modal-body">
                <form id="form_add" class=".form-horizontal" method="post" action="{base}cms/references/add_test"> 
                    ...
                    <input type="text" class="input-xlarge" name="link" placeholder="/italiano/testma-po-italianskomu-yazuku#a1"> 
                </form>
            </div>
            <div class="modal-footer">
                <a href="#" class="btn" data-dismiss="modal">Отмена</a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <form id="formdel" method="post" action="{base}cms/references/delete_test" class="form-inline">
