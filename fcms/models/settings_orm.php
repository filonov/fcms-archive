...
/**
 * Settings_orm DataMapper Model
 *
 * Use this basic model as a template for creating new models.
 * It is not recommended that you include this file with your application,
 * especially if you use a Settings_orm library (as the classes may collide).
 *
 * To use:
 * 1) Copy this file to the lowercase name of your new model.
 * 2) Find-and-replace (case-sensitive) 'Settings_orm' with 'Your_model'
 ...
 */
class Settings_orm extends DataMapper
{
    ...
    // --------------------------------------------------------------------
    // Insert related models that Settings_orm can have just one of.
    var $has_one = array();
    // Insert related models that Settings_orm can have more than one of.
    var $has_many = array();

    /* Relationship Examples
     * For normal relationships, simply add the model name to the array:
     *   $has_one = array('user'); // Settings_orm has one User
     *
     * For complex relationships, such as having a Creator and Editor for
     * Settings_orm, use this form:
     *   $has_one = array(
     *   	'creator' => array(
     *   		'class' => 'user',
