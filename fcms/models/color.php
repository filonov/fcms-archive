...
/**
 * Color DataMapper Model
 *
 * Use this basic model as a template for creating new models.
 * It is not recommended that you include this file with your application,
 * especially if you use a Color library (as the classes may collide).
 *
 * To use:
 * 1) Copy this file to the lowercase name of your new model.
 * 2) Find-and-replace (case-sensitive) 'Color' with 'Your_model'
...
class Color extends DataMapper {
	...
	// Insert related models that Color can have just one of.
	var $has_one = array();

	// Insert related models that Color can have more than one of.
	var $has_many = array();

	/* Relationship Examples
	 * For normal relationships, simply add the model name to the array:
	 *   $has_one = array('user'); // Color has one User
	 *
